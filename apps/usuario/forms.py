...
USUARIO_BASE_FIELDS = ["nombres", "email", "dni", "cuil", "fch_nacimiento", "foto", "sobre_mi"]
        ...
        widgets = {
            "sobre_mi": forms.Textarea(
                attrs={
                    "class": "app-textarea",
                    "rows": 5,
                    "placeholder": "Contá brevemente tu experiencia, enfoque terapéutico y forma de trabajo.",
                }
            ),
